...
function ProductCard({ product, index }: { product: Product; index: number }) {
  ...
  const logoUrl = product.logo_url?.includes("von.png")
    ? "/von.png"
    : product.logo_url?.includes("haku.png")
      ? "/haku.png"
      : product.logo_url?.includes("academy.png")
        ? "/academy.png"
        : product.logo_url?.includes("aevon.png")
          ? "/aevon.png"
          : product.logo_url;
